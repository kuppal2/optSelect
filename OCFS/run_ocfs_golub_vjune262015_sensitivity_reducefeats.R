...
outloc<-paste("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/OCFSvmay2415_v26randseeds_sensitivity_itr",args[9],"/",sep="")
...
evalMode="CV2",
minfitnessthresh=50,
maxnum=3,minnum=3,inertia_method=args[5],particlebehav_method="rankbased",constriction_factor=1,
