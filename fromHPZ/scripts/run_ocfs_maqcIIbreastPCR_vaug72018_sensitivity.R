...
dirloc<-"/home/kuppal2/Documents/Projects/xmsPANDA/Other/Datasets/MAQCII_BreastCancer/"
setwd(dirloc)

outloc<-paste(dirloc,"/OCFSvmay2415_MAQCPCR",args[9],"/",sep="")

sname<-paste(dirloc,"MaqcIIbr.Rda",sep="")
load(sname)
