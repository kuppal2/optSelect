...
#outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/itr2cma_minpres1union_pso5000f0.25c0.25_backwardtrue_cvfoldthres0.7wrand/"
...
#outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/minpres2union_pso1000f0.25c0.25_backwardfalse_cvfoldthres0.7itr4wlininc/"
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/itr5cmapso5000f0.3c0.2_onlypso_backwardtrue_cvfoldthres0.7_wrand/"
#traind<-read.csv("/home/stu/kuppal3/Research/SpectF_data/SPECTF.train", header=FALSE)
...
accWeight=1
featWeight=0.06
minpresent=4 #round(1*length(methods))
...
nn_search<-function(particle_ind, part_group)
{
	...
	fitness_x<-array(100000000000000000, dim=c(num_part, 1)) 
	 fitness_gbest<-(-1)*CMAres$tenfoldacc #10000000000000000
