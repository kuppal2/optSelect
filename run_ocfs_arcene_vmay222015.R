...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vmay2415_v16.R")
...
data_loc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/"
setwd(data_loc)
trainclass<-read.csv("arcene_train.labels", header=FALSE)
testclass<-read.csv("arcene_valid.labels", header=FALSE)

trainm<-read.table("arcene_train.data", sep=" ",header=FALSE)
testm<-read.table("arcene_valid.data", sep=" ",header=FALSE)
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/OCFSvmay2415v16_itr2CMAmultipres1backwsel_max20l0.25f0.45c0.25_minsel0.5rankbehavfeatw0.01_CV2accA100B1wrandconst1/"
