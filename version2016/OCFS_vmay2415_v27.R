...
print(ki_res)
		...
		fitness_res<- eval_fit_test_diff(particle=x,numfolds=numfolds,trainm=trainm,trainclass=trainclass,
                                                testm=trainm,testclass=trainclass,errortype=errortype,kname=kname,accuracyweightA=0.9,
                                                accuracyweightB=0.05,accuracyweightC=0,accuracyweightD=0.001,featweight=featweightcur,max_num_feats=maxnum)
...
#	fitness_res<- eval_fit_test_diff(particle=x[1,], numfolds=numfolds,trainm=trainm,trainclass=trainclass,testm=subtest,testclass=subtestclass,errortype=errortype,kname=kname,weightA=weightA,weightB=weightB,weightC=weightC,weightD=weightD,weightE=featweightcur,max_num_feats=maxnum)

	fitness_res<- eval_fit_test_diff(particle=x[1,],numfolds=numfolds,trainm=trainm,trainclass=trainclass,
