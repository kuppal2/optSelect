...
dirloc<-"/home/kuppal2/Documents/Projects/xmsPANDA/Other/Datasets/Prostate/"

setwd(dirloc)



outloc<-paste(dirloc,"/OCFSvmay2415_Prostate",args[9],"/",sep="")


sname<-paste(dirloc,"Prostate.Rda",sep="")
load(sname)
