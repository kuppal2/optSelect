...
source("/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/OCFS/OCFS_vdec242014.R") #_consistent_setup_evalfit.R")
...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/versionnov2014//CMAandPSO_nov292014v2_ARCENE/"
...
#1
CMAres<-performCMA(trainm, trainclass=trainy, testm, testclass=testy,outloc,
maxnum=0.5,
minnum=3,
stepitr=1,
...
if(FALSE)
{
trainclass<-trainy #CMAres$modtrainclass
testclass<-testy #CMAres$modtestclass
...
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.5,minnum=5,inertia_method="global",particlebehav_method="randbased",constriction_factor=1,select.global.best=TRUE,numnodes=20))
