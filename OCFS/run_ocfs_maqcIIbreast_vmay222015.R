...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vmay2415_v17.R")
...
#trainclass<-MaqcIIbr$trainER
#testclass<-MaqcIIbr$testER

if(FALSE){
trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/GSE20194_series_matrix_train.txt",sep="\t",header=TRUE)
testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/GSE20194_series_matrix_valid.txt",sep="\t",header=TRUE)
trainclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/GSE20194_series_class_train.txt",sep="\t",header=TRUE)
testclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/GSE20194_series_class_valid.txt",sep="\t",header=TRUE)
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/OCFSvmay2415v17_itr1ER_LassoRFELIMMAELpres1backwsel_l0.25f0.45c0.25_top10maxitrs100minselmedianrankbehavfeatw0.01_CV2accA100B1wrand6methodsmax100reptop10/"

#outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/OCFSvmay2415v17_itr4PCRvsRD_LassoRFELIMMAELpres1backwsel_l0.25f0.45c0.25_top10maxitrs100minselmedianrankbehavfeatw0.01_CV2accA100B1wrand6methodsmax100reptop10/"
...
select.global.best=TRUE,numnodes=30,evalFunc=eval_fit_kfold_diff,itr.terminate=FALSE,boostweight=boostweight))
