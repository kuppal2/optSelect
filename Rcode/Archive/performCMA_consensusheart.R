...
#meantrainimt=mean(ncid$Carotid.IMT)
meantrainimt=0.68

ncid$Carotid.IMT[which(ncid$Carotid.IMT>meantrainimt)]="A"
ncid$Carotid.IMT[which(ncid$Carotid.IMT<=meantrainimt)]="B"

testm$Carotid.IMT[which(testm$Carotid.IMT>meantrainimt)]="A"
testm$Carotid.IMT[which(testm$Carotid.IMT<=meantrainimt)]="B"

nci_x<-ncid[,-c(1)]
nci_y<-ncid$Carotid.IMT
nci_xm<-as.matrix(nci_x)
test_xm<-as.matrix(testm[,-c(1)])
test_y<-testm$Carotid.IMT
