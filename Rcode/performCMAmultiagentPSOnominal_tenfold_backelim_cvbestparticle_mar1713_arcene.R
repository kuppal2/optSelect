...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/ARCENE/itr4_backward/"
...
mingenes=1
stepitr=1
methods=c("rf","rfe","limma","lasso") # "kruskal.test", "f.test", "rfe", "lasso", "elasticnet", "wilcox.test", "welch.test", "limma")
#methods=c("t.test")
percentTest=0.40
kname="radial"
maxitrs=100
...
accWeight=1
featWeight=0.01
minpresent=round(0.25*length(methods))
                ...
                {                               
                        ...
                        if (ran[col]<0)         
                        {
                                ...
                                x_curbest[col]<-1
                                                ...
                                                if(agent_behavior<(confusionprob+followerprob)){
