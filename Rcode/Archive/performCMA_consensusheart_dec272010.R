...
ncid$Carotid_IMT<-as.numeric(ncid$Carotid_IMT)
testm$Carotid_IMT<-as.numeric(testm$Carotid_IMT)
...
ncid$Carotid_IMT[which(ncid$Carotid_IMT>(meantrainimt-(-0)))]="A"

ncid$Carotid_IMT[which(ncid$Carotid_IMT<=(meantrainimt-0))]="B"

testm$Carotid_IMT[which(testm$Carotid_IMT>(meantrainimt-(-0)))]="A"
testm$Carotid_IMT[which(testm$Carotid_IMT<=(meantrainimt-0))]="B"
