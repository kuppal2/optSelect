...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/OCFSnov302014_v14itrfeb3_BERbootwrankAll5_l0.2f0.7c0.05_minsel0.9_featmax0_CMAPSObheav5rank/"
...
bootstrap_val=TRUE,
minfitnessthresh=50,
maxnum=0.3,minnum=2,inertia_method="rankbased",particlebehav_method="rankbased",constriction_factor=1,select.global.best=TRUE,numnodes=30))
