...
trainclass<-read.csv("/home/stu/kuppal3/Research/Feature_selection/Datasets/DOROTHEA/dorothea_train.labels", header=FALSE)
testclass<-read.csv("/home/stu/kuppal3/Research/Feature_selection/Datasets/DOROTHEA/dorothea_valid.labels", header=FALSE)

trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/DOROTHEA/dorothea_train.data", sep=" ",header=FALSE)
testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/DOROTHEA/dorothea_valid.data", sep=" ",header=FALSE)
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/DOROTHEA/OCFSv26.4_itr24CMAmultipres1backwsel_top50l0.25f0.45c0.25_minsel0.5rankbehavfeatw0.08_CV2accA1B10wrandconst1/"
