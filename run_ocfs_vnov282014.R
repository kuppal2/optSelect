...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov292014.R")
...
outloc<-"/home/stu/kuppal3/Research/SpectF_data/outputOCFSnov2914_v2_rankbehav_CMAminpres1andPSO10part_18_confintrandseed/"
...
wmax=1,
wmin=0.4,
behavior_reset_itr=3,
maxitrreset=5,
num_neighbors=3,
minselect.pct=0.9,
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.5,minnum=2,inertia_method="global",particlebehav_method="rankbased",constriction_factor=1,select.global.best=TRUE,numnodes=30))
