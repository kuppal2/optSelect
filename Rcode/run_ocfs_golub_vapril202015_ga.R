...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vapr282015_v8.R")
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/OCFSvapr2815v5.1_itr3_LassoRFELIMMAELpres1backwsel_l0.25f0.45c0.25_top10maxitrs100minselmedianrankbehavfeatw0.01_CV2accA100B1wrand6methodsmax100GA/"
...
nir.results = rbga.bin(size=dim(trainm)[2], zeroToOneRatio=10,
         ...
         popSize=10, iters=3, verbose=TRUE)

res1<-list("gares"=nir.results,"trainm"=trainm,"testm"=testm,"trainclass"=trainclass,"testclass"=testclass)
save(nir.results,file="gares.Rda")
