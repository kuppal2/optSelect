...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/versionnov2014//itr1CMAPSO100itrspres1change3max5w1_fit50/"
				...
				if(k>itr)
				{
						...
						break;
							...
							print(itr)
								...
								print(paste("Max init count reachced. Minimum fitness threshold not reached after ",reinit_count," global iterations! Exiting PSO.",sep=""))
								break;
