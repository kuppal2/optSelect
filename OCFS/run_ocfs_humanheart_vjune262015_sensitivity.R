...
load("/home/stu/kuppal3/Research/Feature_selection/Datasets/EmoryHIV/humanheart.Rda")
trainm<-humanheart$X
testm<-humanheart$X
trainclass<-humanheart$Y
testclass<-humanheart$Y
...
#outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Prostate/OCFSvmay2415_v28_itr2_CV2june2615_randbehav_randinertia_max10/"

#outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/OCFSvmay2415_v28_sensitivity_itr23/"

outloc<-paste("/home/stu/kuppal3/Research/Feature_selection/Datasets/EmoryHIV/OCFSvmay2415_v26randseeds_sensitivity_itr",args[9],"/",sep="")
