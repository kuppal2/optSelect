...
print(ki_res)
		...
		fitness_res<- eval_fit_test_diff(particle=x,numfolds=numfolds,trainm=trainm,trainclass=trainclass,
                                                testm=trainm,testclass=trainclass,errortype=errortype,kname=kname,accuracyweightA=0.725,
                                                accuracyweightB=0.025,accuracyweightC=0,accuracyweightD=0.25,featweight=featweightcur,max_num_feats=maxnum)
