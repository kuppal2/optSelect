...
#	fitfunc<-(accuracyweightA*(trainfolderror-trainfolderror_perm))+(accuracyweightB*(testacc))+(accuracyweightC*(folderror_test2))-(accuracyweightD*(trainfolderror_perm))-(featweight*100*(num_feat/length(particle))) 

	
	fitfunc<-(accuracyweightA*(trainfolderror-trainfolderror_perm)^3)+(accuracyweightB*(testacc))+(accuracyweightC*(folderror_test2))+(accuracyweightD*(trainfolderror))-(featweight*100*(num_feat/length(particle)))
