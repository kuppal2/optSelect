...
source("/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/performCMA_consensus_tenfold_ber_nominal_lungheart_train_test_july12013_backward.R")
...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/ARCENE/allmethods_minmethods1_ttestfilt_backwardsel_pso10_itr2all/"
...
accWeight=1
featWeight=0.01
minpresent=length(methods)  #round(0.25*length(methods))
maxfeats=1000 #dim(datafile)[2]-length(removeindex)-1
maxfeatspercent=0.01
evalmethod="CV"
numfolds=10
CVfoldthresh=1
backward.sel=FALSE
...
#roc(dscaledtrain$CySS,deg2CySS.lm$fitted.values)
