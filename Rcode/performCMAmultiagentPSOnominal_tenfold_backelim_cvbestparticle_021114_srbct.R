...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/itr11cmapso100f0.25c0.1_onlypso_backwardtrue_cvfoldthres0.7_w1/"
...
wmax<-1
wmin<-0.4
behavior_reset_itr<-10*itr #(0.5)*itr
maxitrreset<-10000
##################
