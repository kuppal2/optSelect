...
outloc<-paste(data_loc,"OCFSv062016_v32_SRBCT_sensitivity_itr",args[9],"/",sep="")
...
select.global.best=TRUE,numnodes=4,evalFunc=eval_fit_kfold_diff,itr.terminate=FALSE,train.pct=0.7,min.iter.select=1))
