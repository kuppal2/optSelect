...
dirloc<-"/home/kuppal2/Documents/Projects/xmsPANDA/Other/Datasets/BioBank/"
setwd(dirloc)


outloc<-paste(dirloc,"/OCFSvmay2415_BioBank",args[9],"/",sep="")


sname<-paste(dirloc,"/BioBank.Rda",sep="")
load(sname)

#data_loc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/BioBank/"
#data_loc<-"/home/kuppal2/Documents/Projects/xmsPANDA/Other/Datasets/BioBank/"
#load("/home/kuppal3/Research/Feature_selection/Datasets/BioBank/BioBank.rda")
#load("BioBank.rda")

trainm<-BioBank$X
testm<-BioBank$Xt
trainclass<-BioBank$y
testclass<-BioBank$yt
