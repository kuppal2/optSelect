...
sname<-paste("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vmay2415_v",args[9],".R",sep="")
...
outloc<-paste("/home/stu/kuppal3/Research/Feature_selection/Datasets/Prostate/OCFSvmay2415_v25_sensitivity_itr",args[9],"/",sep="")
