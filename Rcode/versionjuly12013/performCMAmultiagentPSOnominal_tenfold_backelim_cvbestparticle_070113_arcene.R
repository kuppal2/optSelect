...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/minpres1union_pso1000f0.25c0.25_backwardfalse_cvfoldthres0.7itr20_wrand/"
...
accWeight=1
featWeight=0.06
minpresent=length(methods) #round(0.7*length(methods))
