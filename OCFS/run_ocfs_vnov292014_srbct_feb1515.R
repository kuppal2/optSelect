...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov302014_v20.R")
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/OCFSnov302014v20feb10CVwgloballimmaiforwselPSO10itrl0.45f0.45c0.05_minsel0.9_featmax0.1_CMAPSOrandbehav5_cons1itr8/"
...
minnum=3,
stepitr=1,
gsmethods=c("limma"), #"rf","rfe","lasso","elasticnet"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
percentTest=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
...
c2=2.05,
itr=10,
globalpso_maxitr=3, #number of iterations of PSO
global_max_itr=30, # number of max resets allowed
num_part=20,
kname="radial",
errortype="BER",
accuracyweightA=5,
...
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.1,minnum=2,inertia_method="global",particlebehav_method="randbased",constriction_factor=1,select.global.best=TRUE,numnodes=30, bootstrap.itr=3))
