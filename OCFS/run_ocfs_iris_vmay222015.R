...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vmay2415_v19.R")
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/IRIS_Probe/OCFSvmay2415_v19_itr1_CMAb3PSO_l1f0c0.05minsel0.5rankbehavfeatw0.01_a10b20_CV2onlyPSO/"
...
evalMode="CV2",
minfitnessthresh=50,
maxnum=3,minnum=2,inertia_method="random",particlebehav_method="randbased",constriction_factor=1,
select.global.best=TRUE,numnodes=30,evalFunc=eval_fit_kfold_diff,itr.terminate=FALSE,boostweight=NA))
