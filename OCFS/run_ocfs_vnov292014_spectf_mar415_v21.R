...
outloc<-"/home/stu/kuppal3/Research/SpectF_data/outputOCFSv21_Limmanovarsel_maxnum22.7pct_minsel0.25_itr5/"
...
#outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/OCFSv21_itr1_LIMMApres1backwsel_l0.45f0.45c0.05_minsel0.3randbehavfeatw0.01_local_maxnum10/"
...
minnum=3,
stepitr=1,
gsmethods=c("limma"), #"lasso","rf","rfe"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
percentTest=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
...
CVeval="CV1",
minfitnessthresh=50,
maxnum=0.3,minnum=2,inertia_method="global",particlebehav_method="randbased",constriction_factor=1,select.global.best=TRUE,numnodes=30,trainlearningsets=learningsets))
