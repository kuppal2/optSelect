...
source("/home/stu/kuppal3/Research/Feature_selection/performCMA_consensus_tenfold_ber_nominal_lungheart_train_test_feb282011_usecmaeval.R")
...
outloc<-"/home/stu/kuppal3/Research/SpectF_data/Results/itr3_ms_parallel/"
temp2=t(traind)
...
mingenes=1
stepitr=1
methods=c("rf", "kruskal.test", "f.test", "rfe", "lasso", "elasticnet")
#methods=c("rfe")
percentTest=0.40
kname="radial"
maxitrs=10
...
maxfeats=200 #dim(datafile)[2]-length(removeindex)-1
maxfeatspercent=1
...
d_dim<-dim(trainm)
	...
	eval_fit_kfold_diff<-function(particle)
	{
		...
		if(num_feat>1)
		{
			...
			#folderror<-quantile(model$accuracies)[4]
