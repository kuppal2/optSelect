...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/OCFSnov302014_v11itr4_wrankcmaLIMMA_l0.4f0.4c0.05_minsel0.9_featmax0_CMAPSO/"
...
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.3,minnum=2,inertia_method="global",particlebehav_method="rankbased",constriction_factor=1,select.global.best=TRUE,numnodes=30))
