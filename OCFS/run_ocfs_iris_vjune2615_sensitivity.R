...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/IRIS_Probe/OCFSvmay2415_v28_sensitivity_itr1/"
...
minnum=3,
stepitr=1,
gsmethods=c("limma","lasso",,"rf","rfe","elasticnet", "f.test"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
pct_train=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
