...
trainy<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.ytrain", header=FALSE)
testy<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.ytest", header=FALSE)
trainy<-t(trainy)
testy<-t(testy)
...
traind<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.xtrain")

testd<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.xtest")
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/itr5cmapso5000f0.3c0.2_minpres3rfrfeellassounion_backwardtrue_cvfoldthres0.7_wrand/"
...
accWeight=1
featWeight=0.06
minpresent=3 #round(1*length(methods))
