...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov262014.R")
...
outloc<-"/home/stu/kuppal3/Research/SpectF_data/outputOCFSnov2714_randbehavreset500maxreset10_1/"
...
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.5,minnum=5,inertia_method="global",particlebehav_method="randbased",constriction_factor=1,select.global.best=TRUE,numnodes=30)
