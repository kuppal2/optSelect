...
if(FALSE)
{
trainclass<-read.csv("/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/ARCENE/arcene_train.labels", header=FALSE)
testclass<-read.csv("/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/ARCENE/arcene_valid.labels", header=FALSE)
...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/versionnov2014//CMAPSO100itrgmax1maxitr30fit70featw100to0.08_randbehavf0.35l0.35c0.151itr_randtopol/"


trainm<-read.csv("/home/stu/kuppal3/Research/SpectF_data/SPECTF.train",header=FALSE)
testm<-read.csv("/home/stu/kuppal3/Research/SpectF_data/SPECTF.test",header=FALSE)
outloc<-"/home/stu/kuppal3/Research/SpectF_data/outputOCFSnov2914_v2_rankbehav_CMAminpres1andPSO10part_40/"


trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/khan.xtrain",header=FALSE)
testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/khan.xtest",header=FALSE)
trainclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/khan.ytrain", header=FALSE)
testclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/khan.ytest", header=FALSE)

trainm<-t(trainm)
testm<-t(testm)


trainclass<-read.csv("/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/arcene_train.labels", header=FALSE)
testclass<-read.csv("/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/arcene_valid.labels", header=FALSE)

trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/arcene_train.data", sep=" ",header=FALSE)
testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/arcene_valid.data", sep=" ",header=FALSE)
...
trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.xtrain",header=FALSE)
testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.xtest",header=FALSE)
trainclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.ytrain",header=FALSE)
testclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/14cancer.ytest",header=FALSE)
...
trainm<-read.table("",header=FALSE)
testm<-read.table("",header=FALSE)
trainclass<-read.table("",header=FALSE)
testclass<-read.table("",header=FALSE)
}

if(FALSE){
trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.train.data.txt",header=TRUE)
testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.test.data_vfinal.txt",header=TRUE)
trainclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.train.labels.txt",header=TRUE)
testclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.test.labels.txt",header=TRUE)
}
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/OCFSv26.2_itr22_LassoRFELIMMAELpres1backwsel_top50l0.3f0.45c0.2_minsel0.5rankbehavfeatw0.01_CV2accA100B1wrandconst1/"
...
minnum=3,
stepitr=1,
gsmethods=c("limma", "f.test","lasso","rfe","elasticnet"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
percentTest=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
