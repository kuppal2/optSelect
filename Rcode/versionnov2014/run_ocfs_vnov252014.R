...
source("/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/versionnov2014/OCFS_vnov262014.R")
...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Rcode/versionnov2014//CMAPSO100itrgmax1maxitr30fit70featw100to0.08_rankbehavf0.35l0.35c0.15100itr_randtopol/"
...
#2
psores<-run_pso(trainm,trainclass,transition_matrix,c1=2.05,
c2=2.05,
itr=10,
globalpso_maxitr=1,
global_max_itr=30,
...
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.5,minnum=5,inertia_method="rankbased",particlebehav_method="randbased",select.global.best=TRUE,numnodes=20)
