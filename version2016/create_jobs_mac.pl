...
$dir="/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/version2016/";
...
@files=("golub","prostate","srbct","maqcIIbreastPCR","maqcIIbreastER","arcene");

open inf, ">runjobs_OCFS_1.sh";
...
#	open inf, ">jobs".$files[$f]."itr".$itr_n."max".$max_k[$k]."0620$files[$f].cmd";



#23
$outf="nohup R --no-save --args $weightcomb[0] $weightcomb[1] $weightcomb[2] $weightcomb[3] global 0.45 0.2 0.25 $itr_n $max_k[$k] < run_ocfs_$files[$f]_vjune202016_sensitivity.R > n$files[$f]$max_k[$k]globalnochange5itrreset5nod1pct083116.out &";
print inf $outf."\n";
