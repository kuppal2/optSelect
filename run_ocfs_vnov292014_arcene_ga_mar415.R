...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/OCFSv27_itr5LIMMApres1backwsel_l0.45f0.45c0.05_minsel0.5rankbehavfeatw0.01_CV1wrand_1presback/"
...
minnum=3,
stepitr=1,
gsmethods=c("limma","lasso","rfe"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
percentTest=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
...
evalMode="CV1",
minfitnessthresh=50,
maxnum=3,minnum=3,inertia_method="random",particlebehav_method="randbased",constriction_factor=0.7,
