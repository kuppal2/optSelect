...
outloc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/ARCENE/itr7_backwardf0.2c0.4/"
...
mingenes=1
stepitr=1
methods=c("rf", "rfe","lasso","elasticnet","kruskal.test") #,"elasticnet") #"f.test", "rfe", "lasso", "elasticnet", "wilcox.test", "welch.test", "limma")
#methods=c("t.test")
percentTest=0.40
kname="radial"
maxitrs=100
...
accWeight=1
featWeight=0.01
minpresent=2 #round(0.25*length(methods))
maxfeats=1000 #dim(datafile)[2]-length(removeindex)-1
maxfeatspercent=0.10
