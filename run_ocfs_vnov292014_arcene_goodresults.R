...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov302014_v13.R")
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/OCFSnov302014_v13itr1_wrankcmamulti_l0.4f0.4c0.05_minsel0.9_featmax10_CMAPSO_behav5000itr/"
...
minnum=3,
stepitr=1,
gsmethods=c("rfe","limma"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
percentTest=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
...
wmax=1,
wmin=0.4,
behavior_reset_itr=5000,
maxitrreset=3,
num_neighbors=3,
minselect.pct=0.9,
bootstrap_val=FALSE,
minfitnessthresh=50,
maxnum=0.3,minnum=2,inertia_method="global",particlebehav_method="randbased",constriction_factor=1,select.global.best=TRUE,numnodes=30))
