...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/itr4cmapso5000f0.3c0.2_minpres2rfrfeelunion_backwardtrue_cvfoldthres0.7_wrand/"
...
accWeight=1
featWeight=0.06
minpresent=2 #round(1*length(methods))
