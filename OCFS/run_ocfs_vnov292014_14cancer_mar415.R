...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov302014_v26.2.1.R")
#source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov302014_v29.R")
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/14Cancer/OCFSv26.2.1_itr2_LassoRFELIMMApres1novarsel_top50l0.3f0.45c0.2_minsel0.5rankbehavfeatw0.01_CV2accA100B1wrandconst1/"
...
minnum=3,
stepitr=1,
gsmethods=c("limma","lasso","rfe","elasticnet","rf","f.test"), #"lasso","elasticnet","kruskal.test"), #"f.test", "f.test", "elasticnet", "wilcox.test", "welch.test"),
percentTest=0.40,
accuracyweight=1,
featweight=0.06,
minpresent=1,
...
select.global.best=TRUE,numnodes=50,evalFunc=eval_fit_kfold_diff,percentTrain=0.8,itr.terminate=FALSE))
