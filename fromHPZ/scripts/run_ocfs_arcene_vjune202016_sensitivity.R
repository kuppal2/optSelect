...
#data_loc<-"/Users/karanuppal/Documents/Gatech/Projects/Algorithms/TwostagePSO/Datasets/ARCENE/"
data_loc<-"/home/kuppal2/Documents/Projects/xmsPANDA/Other/Datasets/ARCENE/"
setwd(data_loc)
#load("/home/stu/kuppal3/Research/Feature_selection/Datasets/MAQCII_BreastCancer/MaqcIIbr.Rda")


outloc<-paste(data_loc,"OCFSv062016_v32_Arcene_sensitivity_itr",args[9],"/",sep="")
...
cnames<-c("trainclass",cnames)
colnames(trainm)<-cnames

cnames<-c("testclass",cnames[-1])
colnames(testm)<-cnames
