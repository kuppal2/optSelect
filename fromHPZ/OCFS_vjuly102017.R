...
#function to evaluate k-fold CV
eval_fit_test_diff<-function(particle, numfolds,trainm,trainclass,testm,testclass,errortype="AUC",kname="radial",featweight=0.05,accuracyweightA=0.4,
accuracyweightB=0.4,accuracyweightC=0.1,accuracyweightD=0.1,max_num_feats=10)
{
    ...
    if(num_feat>2)
    {
        ...
        origtenfoldacc<-{}
        perm_acc<-{}
        seed_vec<-c(129532,839147,407700,99,99999)
        ...
        #if(num_feat>max_num_feats)
        {
            ...
            fitfunc<-(accuracyweightA*(trainfolderror-trainfolderror_perm))+accuracyweightB*(testacc)+accuracyweightC*(folderror_test2)+accuracyweightD*(folderror)+((featweight*(max((100*(max_num_feats-num_feat))/max_num_feats,100))))
...
check_file<-try(load("res.Rda"),silent=TRUE)
