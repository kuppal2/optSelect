...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/minpres1union_pso1000f0.25c0.25_backwardfalse_cvfoldthres0.7itr3wrand/"
			...
			else
			{
				...
				if(no_change>maxitr)
				{
					print("RE-INITIALIZING...")
				 	print(paste("No change for ",maxitr," iterations",sep=""))	
					 fitness_lbest<-array(100000000000000000, dim=c(num_part, 1))
