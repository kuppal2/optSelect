...
outloc<-paste(data_loc,"OCFSv061916_v32_ER_sensitivity_itr",args[9],"/",sep="")
dir.create(outloc)
setwd(outloc)
...
select.global.best=TRUE,numnodes=2,evalFunc=eval_fit_kfold_diff,itr.terminate=FALSE,train.pct=0.8))
