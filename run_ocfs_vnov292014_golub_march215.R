...
source("/home/stu/kuppal3/Research/Feature_selection/Rcode/versionnov2014/OCFS_vnov302014_v24.R")
...
testclass<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/khan.ytest", header=FALSE)
 ...
 trainclass<-read.csv("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.train.labels.txt", header=TRUE)
 testclass<-read.csv("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.test.labels.txt", header=TRUE)

 trainm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.train.data.txt", sep="\t",header=TRUE)
 testm<-read.table("/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/golub.test.data_vfinal.txt", sep="\t",header=TRUE)
...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Golub/OCFSv24itr1_LIMMALASSORFEpres1novarsel_l0.45f0.45c0.05minsel0.3randbehavfeatw0.01_local_CV2backwznorm_3/"
...
scheme_val="pairwise", #one-vs-all
iter_learn=1)
