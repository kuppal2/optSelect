...
performCMA<-function(datafile, outloc, maxnum, minnum, step, methods, percentTest,featweight, accuracyweight)
{
...
return(modgenelist=bestgenelist, modtraindata=modtrain, modtestdata=modtest, method=bestmethod, blindtest=testacc)
}
