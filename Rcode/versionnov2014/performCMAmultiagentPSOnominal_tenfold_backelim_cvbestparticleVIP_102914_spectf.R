...
outloc<-"/home/stu/kuppal3/Research/SpectF_data/Results/itr1pso100wlininc_rankbasedbehav5itr_transmatBER_minsel0.5_CV_rep70/"
			...
			for (i in 1:num_part)
			{
				...
				if(k%%behavior_reset_itr==0){
					...
					if(rank_vec[i]>=rank_sum_vec[5]){
					 ...
					 #prob_behavior<-runif(length(prob_behavior),0,1)
