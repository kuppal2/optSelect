...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/Khan_SRBCT/itr1pso100f0.8c0.1_behav10itrbackwardtrue_cvfoldthres0.7_wlininc/"
...
find_similar_samples<-function(bcdata, targetdata){
	data_dim<-dim(bcdata)
	...
	dist.matrix<-ann(ref=as.matrix(bcdata), target=targetdata, tree.type="brute", k=100, split.rule="midpt", shrink.rule="centroid", verbose=TRUE)
