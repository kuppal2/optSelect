...
outloc<-"/home/stu/kuppal3/Research/Feature_selection/Datasets/ARCENE/itr8_backward/"
...
mingenes=1
stepitr=1
methods=c("rf", "kruskal.test", "f.test", "rfe", "lasso", "elasticnet", "wilcox.test", "welch.test", "t.test")
#methods=c("t.test")
percentTest=0.40
kname="radial"
maxitrs=100
