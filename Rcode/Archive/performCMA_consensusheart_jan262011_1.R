...
performCMA<-function(datafile, outloc, maxnum, minnum, stepitr, gsmethods, percentTest,featweight, accuracyweight, kname, maxitrs, minpresent, norm_method)
{
...
ncid$Carotid_IMT[which(ncid$Carotid_IMT>=upsep)]="A"


#ncid<-ncid[which(ncid$Carotid_IMT=="A" || ncid$Carotid_IMT=="B"),]

ncid$Carotid_IMT[which(ncid$Carotid_IMT<=dsep)]="B"
ncidA<-ncid[which(ncid$Carotid_IMT=="A"),]
ncidB<-ncid[which(ncid$Carotid_IMT=="B"),]
ncid<-rbind(ncidA,ncidB)
print(levels(ncid))
testm$Carotid_IMT[which(testm$Carotid_IMT>=upsep)]="A"
testm$Carotid_IMT[which(testm$Carotid_IMT<=dsep)]="B"
testmA<-testm[which(testm$Carotid_IMT=="A"),]
testmB<-testm[which(testm$Carotid_IMT=="B"),]
